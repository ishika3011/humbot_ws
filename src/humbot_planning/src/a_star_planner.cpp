...
#include "humbot_planning/a_star_planner.hpp"
...
void AStarPlanner::configure(
        ...
        //for robot's position, for receiving maps
{
    node_ = parent.lock();//to initialise Shared ptr from WEAK ptr
    name_ = name;
    tf_ = tf;
...
PLUGINLIB_EXPORT_CLASS(humbot_planning::AStarPlanner, nav2_core::GlobalPlanner)