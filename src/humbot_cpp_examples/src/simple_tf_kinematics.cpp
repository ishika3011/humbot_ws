#include "humbot_cpp_examples/simple_tf_kinematics.hpp"
...

{
    ...
    static_transform_stamped_.header.frame_id = "humbot_base";
    static_transform_stamped_.child_frame_id = "humbot_top";
    static_transform_stamped_.transform.translation.x = 0.0;
    static_transform_stamped_.transform.translation.y = 0.0;
    static_transform_stamped_.transform.translation.z = 0.3; // Example height offset

    //quaterion used for rotation   
    ...
    static_transform_stamped_.transform.rotation.w = 1.0; // this quaterian shows No rotation
    ...
    get_transform_srv_ = create_service<humbot_msgs::srv::GetTransform>(
        "get_transform", std::bind(&SimpleTfKinematics::getTransformCallback, this, _1, _2)); 
        
    last_orientation_.setRPY(0, 0, 0); // No rotation
    orientation_increment_.setRPY(0, 0, 0.5);
...
void SimpleTfKinematics::timerCallback()
{
    ...
    dynamic_transform_stamped_.child_frame_id = "humbot_base";
    ...
    dynamic_transform_stamped_.transform.translation.z = 0.0; // No height offset
    ...
    dynamic_transform_stamped_.transform.rotation.w = q.w(); // aligned same as humbot base
...
bool SimpleTfKinematics::getTransformCallback(const std::shared_ptr<humbot_msgs::srv::GetTransform::Request> req,
                                              const std::shared_ptr<humbot_msgs::srv::GetTransform::Response> res){
    ...
    try{
        ...
        RCLCPP_ERROR_STREAM(get_logger(), "Could not get transform: " << 
